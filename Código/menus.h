...
int menuListar( ){
    ...
    do{
        ...
        printf( "LISTAR: \n"	
                ...
                "[0] | Voltar\n\n-> " );
        fgets(resposta, 3, stdin );
        if( !(resposta[0] == Professor) && !(resposta[0] == Aluno) && !(resposta[0] == Disciplina) && !(resposta[0] == Aniversariantes) && !(resposta[0] == Voltar)){
             puts("   ^ Valor inserido inválido! \n");
        }else putchar('\n');
    }while( !(resposta[0] == Professor) && !(resposta[0] == Aluno) && !(resposta[0] == Disciplina) && !(resposta[0] == Aniversariantes) && !(resposta[0] == Voltar) );
...
int menuListarProfessor( ){
    char resposta[3];
    enum MENU{ Filtro_Geral = '1', Filtro_Sexo = '2', Filtro_Nome = '3', Filtro_Nascimento = '4', Filtro_Buscar = '5', Encerrar_Programa = '0'};
    ...
    do{
            puts( "=====================================\n"
                  ...
                  "=====================================\n"
                    ...
                    "[0] | Voltar \n\n-> ");
            fgets(resposta, 3, stdin );  
            if( !(resposta[0] == Filtro_Geral) && !(resposta[0] == Filtro_Sexo) && !(resposta[0] == Filtro_Nome) && !(resposta[0] == Filtro_Nascimento) && !(resposta[0] == Filtro_Buscar) && !(resposta[0] == Encerrar_Programa)){
            }else putchar('\n');
        }while( !(resposta[0] == Filtro_Geral) && !(resposta[0] == Filtro_Sexo) && !(resposta[0] == Filtro_Nome) && !(resposta[0] == Filtro_Nascimento) && !(resposta[0] == Filtro_Buscar) && !(resposta[0] == Encerrar_Programa));
    return resposta[0];
}
